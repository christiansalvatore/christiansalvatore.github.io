...
## Cuingnet-509
This is a dataset of 509 patients from ADNI, including 137 AD, 76 MCIc, 134 MCInc, 162 CN. ID of patients (from ADNI) are published online. In the original paper, structural MRI images (T1-weighted @ 1.5T) were used.
...
## Moradi-825
This is a dataset of 825 patients from ADNI, including 200 AD, 164 MCIc, 100 MCInc, 100 unknown MCI (uMCI) and 231 CN. In the original paper, structural MRI images (T1-weighted @ 1.5T) and age and cognitive measures were used. ID of patients (from ADNI) are published online.
...
|Result   |Method   |Reference   |Sensitivity   |Specificity   |AUC   |
|:---|:---|:---|:---|:---|:---|
|0.78|Multiple approaches + SVM|<a href="" target="_blank">PRL 2016</a>|0.88|0.68|-|
...
|Result   |Method   |Reference   |Sensitivity   |Specificity   |AUC   |
|:---|:---|:---|:---|:---|:---|
|0.67|Multiple approaches + SVM|<a href="" target="_blank">PRL 2016</a>|0.65|0.68|-|
